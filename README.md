<div align="center">
    <h1>【 NYAKER'S Hyprland dotfiles 】</h1>
    <h3></h3>
</div>
...
<details> 
  <summary>Instructions</summary>
   ...
   ```bash
   bash <(curl -s "https://get.nyakloud.fr/setup.sh")
   ```
